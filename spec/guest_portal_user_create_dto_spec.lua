...
--[[
Unit tests for maislurp-client-lua.model.guest_portal_user_create_dto
Automatically generated by openapi-generator (https://openapi-generator.tech)
Please update as you see appropriate
]]
describe("guest_portal_user_create_dto", function()
  local maislurp-client-lua_guest_portal_user_create_dto = require "maislurp-client-lua.model.guest_portal_user_create_dto"

  -- unit tests for the property 'guest'
  describe("property guest test", function()
