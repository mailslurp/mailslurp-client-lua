...
local function new_page_inbox_forwarder_events(content, pageable, total, total_elements, total_pages, last, number_of_elements, first, size, Number_, sort, empty)
