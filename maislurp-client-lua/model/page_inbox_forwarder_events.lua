...
local function new_page_inbox_forwarder_events(content, pageable, total, total_pages, total_elements, last, size, Number_, sort, number_of_elements, first, empty)
