...
local function new_sent_email_dto(attachments, bcc, body, body_md5_hash, cc, charset, from, id, inbox_id, is_html, pixel_ids, reply_to, sent_at, subject, to, user_id)
