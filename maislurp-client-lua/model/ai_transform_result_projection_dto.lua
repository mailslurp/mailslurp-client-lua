...
local function new_ai_transform_result_projection_dto(id, ai_transform_id, ai_transform_mapping_id, user_id, value, entity_id, entity_type, sms_id, email_id, attachment_id, created_at)
