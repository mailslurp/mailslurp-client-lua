...
local function new_webhook_projection(url, password, username, user_id, inbox_id, event_name, updated_at, created_at, health_status, ai_transformer_id, ai_transform_id, phone_number_id, name, id)
