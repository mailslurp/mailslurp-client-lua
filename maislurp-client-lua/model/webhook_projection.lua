...
local function new_webhook_projection(url, password, username, inbox_id, user_id, event_name, updated_at, created_at, ai_transform_id, health_status, phone_number_id, name, id)
