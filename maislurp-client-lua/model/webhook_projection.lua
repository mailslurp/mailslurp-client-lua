...
local function new_webhook_projection(url, password, username, user_id, inbox_id, event_name, created_at, updated_at, health_status, ai_transformer_id, ai_transform_id, phone_number_id, name, id)
