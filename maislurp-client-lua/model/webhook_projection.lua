...
local function new_webhook_projection(url, password, username, updated_at, user_id, inbox_id, event_name, created_at, ai_transform_id, health_status, ai_transformer_id, phone_number_id, name, id)
