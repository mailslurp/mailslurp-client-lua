...
local function new_page_email_validation_request(content, pageable, total, last, total_pages, total_elements, size, Number_, sort, first, number_of_elements, empty)
