...
local function new_inbox_preview(id, domain_id, email_address, created_at, favourite, name, tags, team_access, inbox_type, virtual_inbox, expires_at, functions_as)
