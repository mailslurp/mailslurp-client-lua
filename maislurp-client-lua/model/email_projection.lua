...
local function new_email_projection(inbox_id, attachments, created_at, to, bcc, cc, domain_id, read, body_excerpt, team_access, body_md5_hash, text_excerpt, subject, id, from)
