...
local function new_email_projection(subject, inbox_id, attachments, sender, recipients, size_bytes, created_at, to, cc, bcc, message_id, domain_id, favourite, plus_address, imap_uid, in_reply_to, read, body_excerpt, text_excerpt, body_part_content_types, body_md5_hash, team_access, id, thread_id, from)
