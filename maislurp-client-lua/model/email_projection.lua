...
local function new_email_projection(id, thread_id, from, subject, sender, recipients, inbox_id, attachments, size_bytes, created_at, to, cc, bcc, message_id, favourite, domain_id, plus_address, imap_uid, in_reply_to, read, body_excerpt, text_excerpt, body_part_content_types, body_md5_hash, team_access)
