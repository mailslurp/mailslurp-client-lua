...
local function new_create_ai_transformer_mapping_options(name, ai_transform_id, entity_id, entity_type, content_selector, trigger_selector, spread_root_array, match_options)
