...
local function new_phone_number_projection(name, id, user_id, phone_country, created_at, provider_label, line_type, carrier_name, mobile_country_code, mobile_network_code, phone_number)
