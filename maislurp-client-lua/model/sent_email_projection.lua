...
local function new_sent_email_projection(id, subject, from, sender, recipients, attachments, inbox_id, user_id, created_at, to, cc, bcc, message_id, in_reply_to, body_excerpt, text_excerpt, body_md5_hash, virtual_send, thread_id)
