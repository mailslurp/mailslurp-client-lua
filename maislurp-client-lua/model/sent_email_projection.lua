...
local function new_sent_email_projection(subject, created_at, id, from, sender, recipients, user_id, attachments, inbox_id, to, cc, bcc, message_id, in_reply_to, body_excerpt, text_excerpt, body_md5_hash, virtual_send, thread_id)
