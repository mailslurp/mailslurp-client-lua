...
local function new_sent_email_projection(subject, id, user_id, inbox_id, attachments, from, sender, recipients, created_at, to, cc, bcc, message_id, in_reply_to, virtual_send, body_excerpt, text_excerpt, body_md5_hash, thread_id)
