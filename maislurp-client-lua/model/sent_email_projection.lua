...
local function new_sent_email_projection(subject, id, message_id, user_id, attachments, inbox_id, created_at, to, cc, bcc, from, sender, recipients, in_reply_to, virtual_send, body_excerpt, text_excerpt, body_md5_hash, thread_id)
