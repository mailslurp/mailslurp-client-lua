...
local function new_page_missed_email_projection(content, pageable, total, last, total_elements, total_pages, size, Number_, sort, first, number_of_elements, empty)
