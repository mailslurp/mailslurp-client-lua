...
local function new_page_tracking_pixel_projection(content, pageable, total, total_pages, total_elements, last, size, Number_, sort, number_of_elements, first, empty)
