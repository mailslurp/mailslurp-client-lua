...
local function new_email_thread_projection(sender, recipients, user_id, inbox_id, updated_at, created_at, to, cc, bcc, has_attachments, message_count, last_body_excerpt, last_text_excerpt, last_created_at, last_from, last_sender, unread, subject, id, from)
