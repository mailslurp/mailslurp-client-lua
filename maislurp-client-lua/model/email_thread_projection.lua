...
local function new_email_thread_projection(id, from, subject, sender, recipients, user_id, inbox_id, created_at, to, cc, bcc, updated_at, has_attachments, unread, message_count, last_body_excerpt, last_text_excerpt, last_created_at, last_from, last_sender)
