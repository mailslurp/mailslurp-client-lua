...
local function new_email_thread_projection(subject, user_id, inbox_id, sender, recipients, updated_at, created_at, to, cc, bcc, has_attachments, last_created_at, last_from, last_sender, unread, message_count, last_body_excerpt, last_text_excerpt, id, from)
