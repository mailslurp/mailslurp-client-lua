...
local function new_email_thread_projection(subject, updated_at, user_id, inbox_id, created_at, to, cc, bcc, sender, recipients, has_attachments, unread, message_count, last_body_excerpt, last_text_excerpt, last_created_at, last_from, last_sender, id, from)
