...
local function new_page_phone_number_projection(content, pageable, total, last, total_pages, total_elements, size, Number_, sort, first, number_of_elements, empty)
