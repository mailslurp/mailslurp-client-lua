...
local function new_page_phone_number_projection(content, pageable, total, total_elements, total_pages, last, number_of_elements, first, size, Number_, sort, empty)
