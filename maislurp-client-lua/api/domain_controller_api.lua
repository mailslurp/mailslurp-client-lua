...
function domain_controller_api:create_domain(domain_options)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
	...
	req:set_body(dkjson.encode(domain_options))
...
function domain_controller_api:update_domain(id, update_domain_dto)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
	...
	req:set_body(dkjson.encode(update_domain_dto))
