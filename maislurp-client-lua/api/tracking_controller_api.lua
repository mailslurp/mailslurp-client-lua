...
function tracking_controller_api:get_all_tracking_pixels(page, search_filter, size, sort)
	local req = http_request.new_from_uri({
		scheme = self.default_scheme;
		host = self.host;
		port = self.port;
		path = string.format("%s/tracking/pixels?page=%s&searchFilter=%s&size=%s&sort=%s",
