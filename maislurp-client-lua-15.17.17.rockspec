...
build = {
	...
	modules = {
		...
		["maislurp-client-lua.model.connector_sync_request_result_exception_cause_suppressed"] = "maislurp-client-lua/model/connector_sync_request_result_exception_cause_suppressed.lua";
